package com.north.lat.autocomplete;
...
import com.north.lat.autocomplete.tst.TernarySearchTree;
...
public class KeywordsAutocomplete {
    ...
    public static void main(String[] args) {
        ...
        kac.add("abc");
        System.out.println("args = [" + Lists.newLinkedList(kac.search("ab")) + "]");
        kac.add("中国");
        System.out.println("args = [" + Lists.newLinkedList(kac.search("中")) + "]");
        System.out.println("args = [" + Lists.newLinkedList(kac.search("中国")) + "]");
        System.out.println("args = [" + Lists.newLinkedList(kac.search("zg")) + "]");
        System.out.println("args = [" + Lists.newLinkedList(kac.search("zhong")) + "]");
    }
}
