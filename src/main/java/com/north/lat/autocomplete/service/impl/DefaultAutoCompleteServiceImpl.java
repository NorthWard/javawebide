...
public class DefaultAutoCompleteServiceImpl implements AutoCompleteService {
    @Override
    public List<AutoCompleteTipItem> nextTips(AutoCompleteCondition autoCompleteCondition) {
